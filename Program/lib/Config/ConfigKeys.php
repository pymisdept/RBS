...
class ConfigKeys
{
	...
	const SPECIAL_ROOM_ID = 'special.room.id';
	
	const NORMAL_ROOM_CC_LIST = 'normal.room.cc.list';
	const SPECIAL_ROOM_CC_LIST = 'special.room.cc.list';	
	const TYPEA_CC_LIST = 'typea.room.cc.list';	
	
	const RECEPTION_EMAIL_ADDRESS = 'reception.email.address';
	const ADMIN_EMAIL_ADDRESS = 'admin.email.address';
	const MIS_EMAIL_ADDRESS = 'mis.email.address';	
	const MISSUPORT_EMAIL_ADDRESS = 'missuport.email.address';	
	const CORPCOMM_EMAIL_ADDRESS = 'corpcomm.email.address';
	const SECURITY_EMAIL_ADDRESS = 'security.email.address';	
