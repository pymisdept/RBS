...
{
    public function __construct($seriesId, Date $dateModified, $lastActionBy, $deleteReason)
    {
        ...
        $this->AddParameter(new Parameter(ParameterNames::LAST_ACTION_BY, $lastActionBy));
        $this->AddParameter(new Parameter(ParameterNames::DELETE_REASON, $deleteReason));
    }
}
...
class GetAllActiveResourcesCommand extends SqlCommand
{
    public function __construct()
    {
        parent::__construct(Queries::GET_ALL_ACTIVE_RESOURCES);
    }
}
