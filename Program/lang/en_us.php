...
class en_us extends Language
{
	...
	protected function _LoadStrings()
	{
		...
		$strings['Description'] = 'Remarks';
		$strings['NoDescriptionLabel'] = '(no remarks)';
		$strings['Notes'] = 'Notes';
		...
		$strings['UsernameOrEmail'] = 'Username';
		...
		$strings['ReservationTitle'] = 'Contact Person';
		$strings['ReservationDescription'] = 'Remarks';
		...
		$strings['Cusername'] = 'Created by';
		$strings['Musername'] = 'Modified by';
        // End Strings
		...
		$strings['CustomAttributeErrors'] = 'There are problems with the following fields:';
		$strings['CustomAttributeRequired'] = '%s is a required field.';
		$strings['CustomAttributeInvalid'] = '%s is not valid.';
		...
		$strings['PasswordControlledExternallyError'] = 'Your password is controlled by Microsoft Active Directory and cannot be updated here.';
		...
		$strings['TitleRequiredRule'] = 'Contact Person is required';
		...
		$strings['EditProfile'] = 'My Profile';
		...
		$strings['ReservationCreatedSubjectWithResource'] = 'Room Booking Confirmation for %s';
		$strings['ReservationUpdatedSubjectWithResource'] = 'Room Booking Confirmation for %s (Revised)';
		$strings['ReservationDeletedSubjectWithResource'] = 'Room Booking Cancellation for %s';
		$strings['ReservationCreatedAdminSubjectWithResource'] = 'Room Booking Confirmation for %s';
		$strings['ReservationUpdatedAdminSubjectWithResource'] = 'Room Booking Confirmation for %s (Revised)';
		$strings['ReservationDeleteAdminSubjectWithResource'] = 'Room Booking Cancellation for %s';
