...
<marquee>Reservations must be made at least 24 hours prior to start time. For urgent booking, please contact Reception / Admin Department for assistance.</marquee>
        ...
        <form id="form-reservation" method="post" enctype="multipart/form-data" role="form">
            ...
            <div class="row">
                ...
                <div id="reservationDetails"
                    ...
                    <div class="col-xs-12 col-md-12 reservationLength">
                        <div class="form-group">
                    ...
                    {if !$HideRecurrence}
                    <div class="col-xs-12 col-md-12 reservationResources">
                    ...
                    <div class="col-xs-4 reservationTitle">
            ...
            {if $UploadsEnabled}
				<span id="section_typea_att">
                <div class="row col-xs-12">
                    <div class="col-xs-12 reservationAttachments">

                        <div id="reservationAttachments">
                            <div class="attachment-item">
                                <label for="reservationUploadFile">Upload Logo of Invited Company</label><span class="note">({$MaxUploadSize}
                                MB {translate key=Maximum})</span>
                                <input type="file" {formname key=RESERVATION_FILE multi=false}
