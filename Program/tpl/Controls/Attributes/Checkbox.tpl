...
<div class="form-group {$class}">
    ...
    {elseif $searchmode}
		...
		<input type="checkbox" value="1" id="{$attributeId}" name="{$attributeName} " style="width: 20px"
                   {if $attribute->Value() == "1"}checked="checked"{/if} class="customAttribute form-control {$inputClass}"/>
    {else}
        <div class="checkbox">
