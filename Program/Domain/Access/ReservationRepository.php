...
class DeleteSeriesEventCommand extends EventCommand
{
    ...
    public function Execute(Database $database)
    {
		...
		//print_r($this->series);
		//error_log($this->series->GetDeleteReason());
		
        $database->Execute(new DeleteSeriesCommand($this->series->SeriesId(), Date::Now(), !empty($deletedBy) ? $deletedBy->UserId : null, $this->series->GetDeleteReason()));
    }
}
