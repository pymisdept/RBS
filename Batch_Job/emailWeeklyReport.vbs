...
Const subject = "Room Booking Weekly Summary - "
...
template = ReadFile("C:\batch\weeklyreport_template.html")
...
If not rs.eof Then	
	...
	iCmd = ".\sendEmail.ps1 -from '" & fromEmail & "' -tostr " & "'pollyleung@pyengineering.com,vickylee@pyengineering.com,reception@pyengineering.com'" & " -ccstr  " & "'fyleung@pyengineering.com'" & " -subject '" & subject & "Week " & weekNo & ", " & thisYear & "' -body '" & template & "'"
